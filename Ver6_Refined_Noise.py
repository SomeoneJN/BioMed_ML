# -*- coding: utf-8 -*-
"""
Created on Thu Apr 10 00:54:38 2025
...
from Ver6_noise_and_plot_functions import (
...
custom_noise_level = 0.1  # Default noise level for noisy shape data.
...
noise_inner_y = round(subset_inner_y.std(axis=0).median(), 2)
...
# For each cell, plot normal using a perfect circular spline (blue with markers) and
# noisy using a perfect circular spline (red dashed) with sample points displayed.
# ---------------------
...
# For each cell, plot normal using a perfect circular spline (blue with markers) and
# noisy using a perfect circular spline (red dashed) with sample points.
# ---------------------
